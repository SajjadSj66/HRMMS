...
class Prescription(models.Model):
    ...
    def __str__(self):
        return f"Prescription for {self.patient} - {self.medical_details}"
...
class InsuranceClaim(models.Model):
    ...
    patient = models.ForeignKey(User, on_delete=models.CASCADE, related_name='insurance_claims', limit_choices_to={'is_staff': False})
    medical_record = models.ForeignKey(MedicalRecord, on_delete=models.CASCADE, related_name='insurance_claims')
